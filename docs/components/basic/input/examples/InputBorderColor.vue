...
<style scoped>
.input-border-color-demo {
  max-width: 800px;
}

.input-border-color-demo h3 {
  margin-bottom: 20px;
  font-size: 18px;
  font-weight: 500;
  color: #333;
